        ...
        implements IGuiceModule<GuiceSiteInjectorModule>
{
     ...
     */
    public static Class<? extends IComponentHierarchyBase<?, ?>> loadingPartClass;
     ...
     */
    public static String getDataBindUrl(IComponentBase<?> component)
    {
        ...
        if (bindSites)
        {
            ...
            for (Map.Entry<PageConfiguration, IPage<?>> entry : getPageConfigurations().entrySet())
            {
                ...
                else if (!pc.ignore())
                {
                    ...
                    JWebMPSiteBinder.log.log(Level.CONFIG, "Serving Page URL [{0}] with [{1}]", new Object[]{pc.url(),
